...
(function() {
  ...
  function eb(h) {
    if (T.fSDec) h[Y("`eeDwdouMhrudods")](Y("e`u`@ohl`uhnoHuds`uhnoDoe"), function() {
      T._fTWm && T._fTWm(h)
    })
  }
  ...
  function J(h, m, w, v, Fa) {
    ...
    v.push([h, m, w, Fa]);
    return h.addEventListener ? (h.addEventListener(m, w, Fa), w) : h.attachEvent ? (v = function(m) {
      m = m || window.event;
  ...
  function gb(h) {
    if (h._menuButton) h.exportEnabled ? Ka(h._menuButton) : ta(h._menuButton);
      ...
      J(h._menuButton, "mouseout", function() {
        m || (oa(h._menuButton, {
          ...
          navigator.userAgent.search("MSIE") && oa(h._menuButton.childNodes[0], {
    ...
    if (!h._dropdownMenu && h.exportEnabled && v) {
      ...
      h._dropdownMenu.style.cssText = "position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:" +
        h.toolbar.backgroundColor + ";box-shadow: 2px 2px 10px " + w;
  ...
  function hb(h) {
    if (!ib) {
      var m = !1,
        w = !1;
      "undefined" === typeof pa.Chart.creditHref ? (h.creditHref = Y("iuuqr;..b`ow`rkr/bnl."),
        h.creditText = Y("B`ow`rKR/bnl")) : (m = h.updateOption("creditText"), w = h.updateOption("creditHref"));
  ...
  function ua(h, m, w) {
    ...
    m.getAttribute("state") !==
      w && (m.setAttribute("state", w), m.setAttribute("type", "button"), oa(m, {
        padding: "5px 12px",
        cursor: "pointer",
        "float": "left",
        width: "40px",
  ...
  function xa(h, m) {
    ...
    if (s(this.options.margin) && h.options.subtitles)
      for (var w = h.options.subtitles, v = 0; v < w.length; v++)
  ...
  var Ga = !1,
    ...
    y = v ? "Trebuchet MS, Helvetica, sans-serif" :
    /*색상 코드 #4F81BC #C0504E #9BBB58 #FF9999 #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566*/
    "Arial",
    Da = v ? "Impact, Charcoal, sans-serif" : "Arial",
    ya = {
      colorSet1: "#079c3c #3caa52 #5ab867 #75c67d #8ed393 #a6e1a9 #beefc0 #1b5e20 #33691e".split(" "),
  ...
  var fb = function() {
    ...
    ea = function(h, m, w) {
        ...
        if (m = M.pop(), "#" === m || "0" === m)
          if (N++, N === H) {
            var W = D,
              D = [];
            if ("0" === m)
              for (m = H - Q - (W ? W.length : 0); 0 < m;) W.unshift("0"), m--;
            for (; 0 < W.length;) w = W.pop() + w, J++, 0 === J % F && (L === R && 0 < W.length) && (w = y + w)
          } else 0 < D.length ?
            (w = D.pop() + w, Q++, J++) : "0" === m && (w = "0" + w, Q++, J++), 0 === J % F && (L === R && 0 < D.length) && (w = y + w);
      ...
      y = "";
      for (M = !1; 0 < T.length;) m = T.shift(), "#" === m || "0" === m ? 0 < h.length && 0 !== Number(h.join("")) ?
        (y += h.shift(), M = !0) : "0" === m && (y += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), y += m.replace(/[0]+/, function(a) {
          return X(V, a.length)
        }));
      w += (M ? v : "") + y;
      return s ? "-" + w : w
    ...
    Na = function(h) {
      var m = 0,
        w = 0;
      h = h || window.event;
      h.offsetX || 0 === h.offsetX ? (m = h.offsetX, w = h.offsetY) : h.layerX || 0 == h.layerX ? (m = h.layerX, w =
        h.layerY) : (m = h.pageX - h.target.offsetLeft, w = h.pageY - h.target.offsetTop);
      return {
        x: m,
        y: w
      }
    ...
    Ma = 1,
    ga = Za ? Qa / Ma : 1,
    ca = function(h, m, w, s, v, y, D, F, N, M, T, Q, J) {
      ...
      !0 === M && (h.save(), h.beginPath(), h.moveTo(m, v), h.lineTo(m + H, v - H), h.lineTo(s - H, v - H), h.lineTo(s, v), h.closePath(), D = h.createLinearGradient((s + m) / 2, v - H, (s + m) / 2, v), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, .4)"), h.fillStyle =
        D, h.fill(), h.restore());
      ...
      !0 === Q && (h.save(), h.beginPath(), h.moveTo(s, w), h.lineTo(s - H, w + H), h.lineTo(s - H, v - H), h.lineTo(s, v), D = h.createLinearGradient(s - H, (v + w) / 2, s, (v + w) / 2), D.addColorStop(0, y), D.addColorStop(1, "rgba(255, 255, 255, 0.1)"), h.fillStyle =
    ...
    bb = window && window[Y("mnb`uhno")] && window[Y("mnb`uhno")].href && window[Y("mnb`uhno")].href.indexOf && (-1 !== window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl")) || -1 !== window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))),
    ib = bb && -1 === window[Y("mnb`uhno")].href.indexOf(Y("gheemd")),
    jb = {
      reset: {
  ...
  V.prototype.removeEventListener = function(h, m) {
    if (h && m && this._eventListeners[h])
      for (var s = this._eventListeners[h], v = 0; v < s.length; v++)
  ...
  V.prototype.dispatchEvent = function(h, m, s) {
    if (h && this._eventListeners[h]) {
      m = m || {};
      for (var v = this._eventListeners[h], y = 0; y < v.length; y++) v[y].eventHandler.call(v[y].context,
        m)
    }
  ...
  ia.prototype.render = function(h) {
    if (0 !== this.fontSize) {
      ...
      for (s = 0; s < this._wrappedText.lines.length; s++) {
        ...
        if ("right" === this.horizontalAlign || "right" === this.textAlign) v = this.width - F.width - this.rightPadding;
        else if ("left" === this.horizontalAlign || "left" === this.textAlign) v = this.leftPadding;
        else if ("center" === this.horizontalAlign || "center" === this.textAlign) v = (this.width - (this.leftPadding + this.rightPadding)) / 2 - F.width / 2 + this.leftPadding;
  ...
  xa.prototype.setLayout = function() {
    if (this.text) {
      ...
      M = H.measureText();
      "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (y = m.y1 + 2, J = "top") : "bottom" === this.verticalAlign && (y = m.y2 - 2 - M.height, J = "bottom"), "left" === this.horizontalAlign ? v = m.x1 + 2 : "center" === this.horizontalAlign ? v = m.x1 + m.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (v = m.x2 - 2 - M.width - D), N = this.horizontalAlign,
  ...
  y = Oa.Chart = function() {
      ...
      (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ?
        ...
        (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Aa(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Aa(this._preRenderCtx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = sa(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas), this.plotArea.ctx = this.plotArea.canvas.getContext("2d")),
          this.overlaidCanvas = sa(a, d), this.overlaidCanvas.style.position = "absolute", this.overlaidCanvas.style.webkitTapHighlightColor = "transparent", this.overlaidCanvas.style.WebkitUserSelect = "none", this.overlaidCanvas.style.MozUserSelect = "none", this.overlaidCanvas.style.msUserSelect = "none", this.overlaidCanvas.style.userSelect = "none", this.overlaidCanvas.getContext && (this._canvasJSContainer.appendChild(this.overlaidCanvas), this.overlaidCanvasCtx = this.overlaidCanvas.getContext("2d"), this.overlaidCanvasCtx.textBaseline =
            "top", Aa(this.overlaidCanvasCtx)), this._eventManager = new da(this), this.windowResizeHandler = J(window, "resize", function() {
          ...
          this.toolTip = new X(this, this.options.toolTip), this.data = null, this.axisX = [], this.axisX2 = [], this.axisY = [], this.axisY2 = [], this.sessionVariables = {
            axisX: [],
            axisX2: [],
            axisY: [],
            axisY2: []
    ...
    function y(a, d, c, b, e, f, l, u, A, k) {
      ...
      a.beginPath();
      A && 0 < u.thickness ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - p), a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - p)) : 0 < u.thickness && (a.moveTo(Math.round((d +
    ...
    m.prototype._initialize = function() {
      ...
      this._updateOptions();
      this.animatedRender = v && this.animationEnabled &&
        0 === this.renderCount;
      this._updateSize();
      this.clearCanvas();
      this.ctx.beginPath();
    ...
    m.prototype.renderElements = function() {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (var f = this.plotInfo.plotTypes[d], l = 0; l < f.plotUnits.length; l++) {
          ...
          "line" === u.type ? A = this.renderLine(u) : "stepLine" === u.type ? A = this.renderStepLine(u) : "spline" === u.type ? A = this.renderSpline(u) : "column" === u.type ? A = this.renderColumn(u) : "bar" === u.type ? A = this.renderBar(u) : "area" === u.type ? A = this.renderArea(u) : "stepArea" === u.type ? A = this.renderStepArea(u) : "splineArea" === u.type ? A = this.renderSplineArea(u) :
    ...
    m.prototype._processStackedPlotUnit = function(a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], u = [], A = Infinity, k = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (b < m && !g) null !== p.dataPoints[q].y && (h = b);
              ...
              p.dataPoints[q].label && (a.axisX.labels[b] =
          ...
          a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,
            l), d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, u)) : (d.dataPointYPositiveSums = l, d.dataPointYNegativeSums = u));
        ...
        for (q in u) u.hasOwnProperty(q) && !isNaN(q) && (a = u[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, k)), q <
          c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, k))))
      }
    };
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, u = !1, A = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
          var n = this.data[a.dataSeriesIndexes[k]],
            ...
            g = !1,
            r;
          if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement) var h = a.axisX.sessionVariables.newViewportMinimum ?
            a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
          ...
          if (n.dataPoints[p].x &&
            n.dataPoints[p].x.getTime || "dateTime" === n.xValueType) f = !0;
          for (p = 0; p < n.dataPoints.length; p++) {
            ...
            if (0 < p) {
              ...
              } else t = b - n.dataPoints[p - 1].x, 0 > t && (t *= -1), c.minDiff >
                t && 0 !== t && (c.minDiff = t);
            ...
            if (b < h && !q) null !== e && (r = b);
              ...
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e ? c.viewPortMin === b && r <
                b && (c.viewPortMin = r) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? l = !0 : 0 > e && (u = !0), A[b] = A[b] ? A[b] + Math.abs(e) : Math.abs(e))
            }
          }
          n.axisX.valueType = n.xValueType = f ? "dateTime" : "number"
        }
        a.axisY.logarithmic ? (d.max = s(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && !u ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax,
          99), d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && u ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !l && u && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
        d.viewPortMin = d.min;
        d.viewPortMax = d.max;
        a.dataPointYSums = A
      }
    ...
    m.prototype._processMultiYPlotUnit = function(a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e,
            f, l, u = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          for (n = 0; n < k.dataPoints.length; n++) {
            ...
            f < d.min && (d.min = f);
            l > d.max && (d.max = l);
            0 < n && (a.axisX.logarithmic ? (r = b / k.dataPoints[n - 1].x, 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r)) : (r = b - k.dataPoints[n - 1].x, 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)), e && (null !== e[0] && k.dataPoints[n - 1].y && null !== k.dataPoints[n - 1].y[0]) && (a.axisY.logarithmic ? (r = e[0] /
              k.dataPoints[n - 1].y[0], 1 > r && (r = 1 / r), d.minDiff > r && 1 !== r && (d.minDiff = r)) : (r = e[0] - k.dataPoints[n - 1].y[0], 0 > r && (r *= -1), d.minDiff > r && 0 !== r && (d.minDiff = r))));
            if (!(b < m) || p) {
              if (!p && (p = !0, 0 < n)) {
                n -= 2;
                g = h;
              ...
              if (c.viewPortMin === b && e)
                for (x = 0; x < e.length; x++)
                  if (null === e[x] && g < b) {
                    c.viewPortMin = g;
                    break
                  } null === e ? c.viewPortMin === b && g < b &&
                (c.viewPortMin = g) : (f < d.viewPortMin && (d.viewPortMin = f), l > d.viewPortMax && (d.viewPortMax = l))
            }
          }
    ...
    m.prototype._processSpecificPlotUnit = function(a) {
      if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
        for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
          ...
          if (u.dataPoints[A].x && u.dataPoints[A].x.getTime || "dateTime" === u.xValueType) f = !0;
          for (A = 0; A < u.dataPoints.length; A++) "undefined" !== typeof u.dataPoints[A].isCumulativeSum && !0 === u.dataPoints[A].isCumulativeSum ? (u.dataPointEOs[A].cumulativeSumYStartValue = 0, u.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum, u.dataPoints[A].y = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum) : "undefined" !== typeof u.dataPoints[A].isIntermediateSum && !0 === u.dataPoints[A].isIntermediateSum ? (u.dataPointEOs[A].cumulativeSumYStartValue =
            p, u.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum, u.dataPoints[A].y = 0 === A ? 0 : b, p = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum, b = 0) : (e = "number" !== typeof u.dataPoints[A].y ? 0 : u.dataPoints[A].y, u.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : u.dataPointEOs[A - 1].cumulativeSum, u.dataPointEOs[A].cumulativeSum = 0 === A ? e : u.dataPointEOs[A - 1].cumulativeSum + e, b += e);
          for (A = 0; A < u.dataPoints.length; A++)
            if ("undefined" === typeof u.dataPoints[A].x && (u.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)),
              u.dataPoints[A].x.getTime ? (f = !0, b = u.dataPoints[A].x.getTime()) : b = u.dataPoints[A].x, e = u.dataPoints[A].y, b < c.min && (c.min = b), b > c.max && (c.max = b), u.dataPointEOs[A].cumulativeSum < d.min && (d.min = u.dataPointEOs[A].cumulativeSum), u.dataPointEOs[A].cumulativeSum > d.max && (d.max = u.dataPointEOs[A].cumulativeSum), 0 < A && (a.axisX.logarithmic ? (p = b / u.dataPoints[A - 1].x, 1 > p && (p = 1 / p), c.minDiff > p && 1 !== p && (c.minDiff = p)) : (p = b - u.dataPoints[A - 1].x, 0 > p && (p *= -1), c.minDiff > p && 0 !== p && (c.minDiff = p)), null !== e && null !== u.dataPoints[A -
                1].y && (a.axisY.logarithmic ? (e = u.dataPointEOs[A].cumulativeSum / u.dataPointEOs[A - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = u.dataPointEOs[A].cumulativeSum - u.dataPointEOs[A - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || k) {
              if (!k && (k = !0, 0 < A)) {
                A -= 2;
                continue
              }
              ...
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < A && (u.dataPointEOs[A -
                1].cumulativeSum < d.viewPortMin && (d.viewPortMin = u.dataPointEOs[A - 1].cumulativeSum), u.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = u.dataPointEOs[A - 1].cumulativeSum));
    ...
    m.prototype.calculateAutoBreaks = function() {
      function a(a, b, c, e) {
        if (e) return c =
          Math.pow(Math.min(c * a / b, b / a), 0.2), 1 >= c && (c = Math.pow(1 > a ? 1 / a : Math.min(b / a, a), 0.25)), {
            startValue: a * c,
            endValue: b / c
          };
      ...
      function d(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b ||
            c)
            for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, k = f.min, l = f.max, n = d.min, p = d.max, f = f._dataRanges, d = d._dataRanges, q, u = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
              ...
              if (!(4 > h.dataPoints.length))
                for (u = 0; u < h.dataPoints.length; u++)
                  if (b && (q = (l + 1 - k) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = h.dataPoints[u].x.getTime ? h.dataPoints[u].x.getTime() : h.dataPoints[u].x, q = Math.floor((g - k) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                    var m =
                      (p + 1 - n) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
      ...
      for (var b, e = this, f = !1, l = 0; l <
        ...
        for (l = 0; l < this.plotInfo.plotTypes.length; l++)
          for (f = this.plotInfo.plotTypes[l], u = 0; u < f.plotUnits.length; u++) b = f.plotUnits[u], "line" === b.type ||
        ...
        for (l = 0; l < this._axes.length; l++)
          if (this._axes[l].dataInfo._dataRanges) {
            ...
            if (this._axes[l].dataInfo.dataPointYNegativeSums) {
              ...
              n = k;
              for (u in q) q.hasOwnProperty(u) && !isNaN(u) && (p = -1 * q[u], s(p) || (g = Math.floor((p - A) / b), p < n[g].min && (n[g].min = p), p > n[g].max && (n[g].max = p)));
    ...
    m.prototype.getObjectAtXY = function(a, d, c) {
      ...
      else if (v) b = Ya(a, d, this._eventManager.ghostCtx);
      else
        ...
        if (d.x < c.x1 || d.x > c.x2 || d.y < c.y1 || d.y > c.y2)
          if (this.toolTip && this.toolTip.enabled) {
            ...
            for (f = 0; f < this.axisY2.length; f++) this.axisY2[f].crosshair &&
              this.axisY2[f].crosshair.enabled && this.axisY2[f].crosshair.dispatchEvent("hidden", {
                chart: this,
    ...
    m.prototype._plotAreaMouseMove = function(a, d) {
      if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
        ...
        if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
          ...
          this.validateRegion(b, u, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !==
    ...
    m.prototype.validateRegion = function(a, d, c, b, e) {
      ...
      for (var f = 0 <= this.zoomType.indexOf("x"),
          l = 0 <= this.zoomType.indexOf("y"), u = !1, A = [], k = [], n = [], p = 0; p < this._axes.length; p++)("axisX" === this._axes[p].type && f || "axisY" === this._axes[p].type && l) && k.push(this._axes[p]);
      for (l = 0; l < k.length; l++) {
        ...
        if (isFinite(p.dataInfo.minDiff))
          if (r =
            p.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && p.scaleBreaks && p.scaleBreaks._appliedBreaks.length) && (p.logarithmic && r < Math.pow(p.dataInfo.minDiff, 3) || !p.logarithmic && r < 3 * Math.abs(p.dataInfo.minDiff)) || q < p.minimum || g > p.maximum)) A.push(p), n.push({
            val1: q,
            val2: g
          }), u = !0;
          else if (!e) {
    ...
    m.prototype.renderIndexLabels = function(a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var n = this._indexLabels[a],
          ...
          k = ka("indexLabelFontWeight", n.dataPoint,
            n.dataSeries),
        ...
        var C = n.dataPoint.indexLabelFormatter ? n.dataPoint.indexLabelFormatter(E) : n.dataPoint.indexLabel ?
          this.replaceKeywordsWithValue(n.dataPoint.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : n.dataSeries.indexLabelFormatter ? n.dataSeries.indexLabelFormatter(E) : n.dataSeries.indexLabel ? this.replaceKeywordsWithValue(n.dataSeries.indexLabel, n.dataPoint, n.dataSeries, null, n.indexKeyword) : null;
        if (null !== C && "" !== C) {
          ...
          if ("stackedarea100" === p) {
            ...
            if (n.dataPoint.x < e.viewportMinimum || n.dataPoint.x > e.viewportMaximum ||
              Math.max.apply(null, n.dataPoint.y) < f.viewportMinimum || Math.min.apply(null, n.dataPoint.y) > f.viewportMaximum) continue
            ...
            if (n.dataPoint.x < e.viewportMinimum || n.dataPoint.x > e.viewportMaximum ||
              n.bounds.y1 > c.y2 || n.bounds.y2 < c.y1) continue
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== z ? (e = c.y1, f = c.y2, 0 < B ? (g = n.point.y + ("horizontal" === E ? r / 2 : 0) - k - u - b, g < e && (g = "auto" === z ? Math.max(n.point.y, e) + r / 2 + u : e + r / 2 + u, w = g + k > n.point.y)) : (g = n.point.y + r / 2 + u + b, g > f - k && (g = "auto" ===
          ...
          h.y = g;
          h.render(!0);
          x && ("inside" !== z && (0 > p.indexOf("bar") && ("error" !== p || !n.axisSwapped) && n.point.x > c.x1 && n.point.x < c.x2 || !w) &&
            ...
            k : 0) - r / 2)) : d.lineTo(q + A / 2 - ("horizontal" === E ? 0 : r / 2), g + ("vertical" === E ? g - k < n.point.y ? 0 : -k : (g - r / 2 < n.point.y ? k : 0) - r / 2)), d.stroke())
        }
      }
      d = {
        source: d,
      ...
      for (a = 0; a < this._indexLabels.length; a++) n = this._indexLabels[a], h = ka("indexLabelBackgroundColor", n.dataPoint, n.dataSeries), n.dataSeries.indexLabelBackgroundColor = s(h) ? v ? "transparent" : null : h;
      return d
    };
    m.prototype.renderLine = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length) {
            for (var E = !1, t = 0; t < n.length; t++)
              if (x = n[t].x.getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !E)))
                if ("number" !== typeof n[t].y) 0 <
                  t && !(k.connectNullData || E || m) && (c.stroke(), v && b.stroke()), E = !0;
                else {
                  ...
                  m || E ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x, l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x,
                    s), v && b.lineTo(x, s)) : (c.beginPath(), c.moveTo(x, s), v && (b.beginPath(), b.moveTo(x, s))), E = m = !1) : (c.lineTo(x, s), v && b.lineTo(x, s), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), v && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                  l = {
                    x: x,
                    y: s
                  };
        ...
        W.drawMarkers(f);
        v && (d.drawImage(this._preRenderCanvas, 0,
          ...
          if (0 < n.length) {
            for (var E = !1, t = 0; t < n.length; t++)
              if (x = n[t].getTime ? n[t].x.getTime() : n[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax &&
                  (!k.connectNullData || !E)))
                if ("number" !== typeof n[t].y) 0 < t && !(k.connectNullData || E || m) && (c.stroke(), v && b.stroke()), E = !0;
                else {
                  var C = s;
                  x = a.axisX.convertValueToPixel(x);
                  s = a.axisY.convertValueToPixel(n[t].y);
                  ...
                  m || E ? (!m && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || p === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(l.x,
                    l.y), p = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, C), c.lineTo(x, s), v && (b.lineTo(x, C), b.lineTo(x, s))) : (c.beginPath(), c.moveTo(x, s), v && (b.beginPath(), b.moveTo(x, s))), E = m = !1) : (c.lineTo(x, C), v && b.lineTo(x, C), c.lineTo(x, s), v && b.lineTo(x, s), 0 == t % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), v && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                  l = {
                    x: x,
                    y: s
                  };
    ...
    m.prototype.renderColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null,
          e = this.plotArea,
          f = 0,
          l, u, A, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
            ...
            for (k = 0; k < t.length; k++)
              if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                ...
                var s = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                  E = s + g << 0,
                  C;
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) u[b] = t[k].y + (u[b] ? u[b] :
                  0), 0 < u[b] && (p = a.axisY.convertValueToPixel(u[b]), C = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
            ...
            for (var x = 5 < g && m.bevelEnabled ? !0 : !1, k = 0; k < t.length; k++)
              if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[k].y) {
                ...
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length &&
                  ...
                  typeof l[b] ? l[b] : 0, C = p + B, p = q + B, a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - C) && (C = e.y2), l[b] = B + (C - p);
                b = t[k].color ? t[k].color : m._colorSet[k % m._colorSet.length];
                ca(c, s, p, E, C, b, 0, null, x && 0 <= t[k].y, 0 > t[k].y && x, !1, !1, m.fillOpacity);
                b = m.dataPointIds[k];
                this._eventManager.objectMap[b] = {
    ...
    m.prototype.renderBar = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas,
    ...
    m.prototype.renderStackedBar = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < t.length; k++)
              if (b = t[k].x.getTime ? t[k].x.getTime() :
                ...
                var s = p - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                  E = s + g << 0,
                  C;
                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[k].y) u[b] = t[k].y + (u[b] ? u[b] : 0), 0 < u[b] && (C = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(u[b]));
                ...
                b = Q(b);
                v && ca(this._eventManager.ghostCtx, C, s, n, E, b, 0, null, !1, !1, !1,
                  !1);
                (t[k].indexLabel || m.indexLabel || t[k].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
        ...
        v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && c.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas &&
          ...
          if (0 < t.length) {
            ...
            for (k = 0; k < t.length; k++)
              if (b = t[k].x.getTime ? t[k].x.getTime() : t[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                ...
                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[k].y) A[b] = s + (A[b] ? A[b] : 0), n = l[b] ? l[b] :
                  q, l[b] = s = a.axisY.convertValueToPixel(A[b]);
                else if (n = a.axisY.convertValueToPixel(s), 0 <= t[k].y) {
                  var B = f[b] ? f[b] : 0;
                  s = q + B;
                  n += B;
    ...
    m.prototype.renderArea = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < r.length) {
            ...
            for (var ja = !0; h < r.length; h++)
              if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin ||
                ...
                if ("number" !== typeof r[h].y) g.connectNullData || (ja || d) || b(), ja = !0;
                  ...
                  d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(), f.moveTo(n.x, n.y), m = d, t = c, C = n, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, t), v && l.lineTo(m, t)) : (f.beginPath(), f.moveTo(m, t), v &&
                  ...
                  0 !==
                    r[h].markerSize && (0 < r[h].markerSize || 0 < g.markerSize) && (s = g.getMarkerProperties(h, m, t, f), A.push(s), aa = Q(aa), v && A.push({
                      x: m,
                      y: t,
                      ctx: l,
                      type: s.type,
        ...
        v && (e.drawImage(this._preRenderCanvas, 0, 0,
        ...
        if (0 < c.length) {
          if (0 < n.lineThickness) {
            ...
            for (var d = 0; d < c.length - 3; d += 3)
              if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), v && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(),
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < p.length) {
            var z = n._colorSet[q % n._colorSet.length],
              E = n.lineColor = n.options.lineColor ||
              z,
              C = E;
            b.fillStyle = z;
            b.strokeStyle = E;
            ...
            for (r = !1; q < p.length; q++)
              if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !r)))
                if ("number" !== typeof p[q].y) 0 < q && !r && (n.connectNullData ? b.setLineDash && (0 < s.length && (n.options.nullDataLineDashType || !p[q - 1].lineDashType)) &&
                  (s[s.length - 1].newLineDashArray = y, B = n.nullDataLineDashType) : (d(), s = [])), r = !0;
                else {
                  ...
                  q < p.length - 1 && (C !== (p[q].lineColor || E) || B !== (p[q].lineDashType || n.lineDashType)) && (C = p[q].lineColor || E, s[s.length - 1].newStrokeStyle = C, b.setLineDash && (p[q].lineDashType ? (B = p[q].lineDashType, s[s.length -
                    1].newLineDashArray = N(B, n.lineThickness)) : (B = n.lineDashType, s[s.length - 1].newLineDashArray = D)));
    ...
    m.prototype.renderStepArea = function(a) {
      ...
      function b() {
        C && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? E = z : 0 > a.axisY.viewportMaximum ? E = u.y1 : 0 < a.axisY.viewportMinimum && (E = z), f.lineTo(m, E), f.lineTo(C.x, E), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, v && (l.lineTo(m, E), l.lineTo(C.x,
          E), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, t), l.beginPath(), l.moveTo(m, t), C = {
          x: m,
          y: t
        })
      }
          ...
          if (0 < r.length) {
            ...
            for (; h < r.length; h++)
              if (s = r[h].x.getTime ? r[h].x.getTime() : r[h].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                var aa = t;
                "number" !== typeof r[h].y ? (g.connectNullData || (c || d) || b(), c = !0) : (m = a.axisX.convertValueToPixel(s), t = a.axisY.convertValueToPixel(r[h].y), d || c ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || S === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = t, m = n.x, t = n.y, b(),
                  f.moveTo(n.x, n.y), m = d, t = c, C = n, S = g.nullDataLineDashType, f.setLineDash(P)), f.lineTo(m, aa), f.lineTo(m, t), v && (l.lineTo(m, aa), l.lineTo(m, t))) : (f.beginPath(), f.moveTo(m, t), v && (l.beginPath(), l.moveTo(m, t)), C = {
                  x: m,
                  y: t
                }), c = d = !1) : (f.lineTo(m, aa), v && l.lineTo(m, aa), f.lineTo(m, t), v && l.lineTo(m, t), 0 == h % 250 && b()), n = {
                  x: m,
                  y: t
                }, h < r.length - 1 && (y !== (r[h].lineColor || w) || S !== (r[h].lineDashType || g.lineDashType)) && (b(), y = r[h].lineColor || w, f.strokeStyle = y, f.setLineDash && (r[h].lineDashType ? (S = r[h].lineDashType, f.setLineDash(N(S,
                  g.lineThickness))) : (S = g.lineDashType, f.setLineDash(D)))), s = g.dataPointIds[h], this._eventManager.objectMap[s] = {
                  id: s,
                  objectType: "dataPoint",
                  dataSeriesIndex: q,
                  dataPointIndex: h,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], E = 0; E < a.dataSeriesIndexes.length; E++) {
          var C = a.dataSeriesIndexes[E],
            ...
            w = B.dataPoints;
          B.dataPointIndexes = [];
          for (q = 0; q < w.length; q++) C = w[q].x.getTime ? w[q].x.getTime() : w[q].x, B.dataPointIndexes[C] = q, e[C] || (n.push(C), e[C] = !0);
          n.sort(Pa)
        }
          ...
          if (0 < n.length) {
            ...
            for (var aa = !0, q = 0; q < n.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                if ("number" !== typeof fa.y) B.connectNullData || (aa || x) || d(), aa = !0;
                else {
                  ...
                  h[f] = m - r;
                  x || aa ? (!x && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || z === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (x = k.pop(), z = k[k.length - 1], d(), b.moveTo(t.x, t.y), k.push(z), k.push(x), z = B.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g,
                    r), v && s.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), v && (s.beginPath(), s.moveTo(g, r))), aa = x = !1) : (b.lineTo(g, r), v && s.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), v && s.moveTo(g, r), k.push({
                    x: g,
                    y: m - la
                  })));
                  t = {
                  ...
                  (fa.indexLabel || B.indexLabel || fa.indexLabelFormatter ||
        ...
        W.drawMarkers(l);
        v && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height),
          this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(u.x1, u.y1, u.width, u.height), s.restore());
        b.restore();
        return {
          source: c,
          dest: this.plotArea.ctx,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], E = 0; E < a.dataSeriesIndexes.length; E++) {
          var w = a.dataSeriesIndexes[E],
            ...
            y = B.dataPoints;
          B.dataPointIndexes = [];
          for (q = 0; q < y.length; q++) w = y[q].x.getTime ? y[q].x.getTime() : y[q].x, B.dataPointIndexes[w] = q, e[w] || (n.push(w), e[w] = !0);
          n.sort(Pa)
        }
        for (E = 0; E < a.dataSeriesIndexes.length; E++) {
          ...
          if (0 < n.length) {
            ...
            for (var aa = !0, q = 0; q < n.length; q++) {
              ...
              if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                if ("number" !== typeof fa.y) B.connectNullData ||
                  (aa || s) || d(), aa = !0;
                else {
                  var la;
                  ...
                  h[f] = x - r;
                  s || aa ? (!s && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || t === B.lineDashType &&
                    B.lineDashType !== B.nullDataLineDashType) && (s = k.pop(), t = k[k.length - 1], d(), b.moveTo(m.x, m.y), k.push(t), k.push(s), t = B.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, r), v && z.lineTo(g, r)) : (b.beginPath(), b.moveTo(g, r), v && (z.beginPath(), z.moveTo(g, r))), aa = s = !1) : (b.lineTo(g, r), v && z.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), v && z.moveTo(g, r), k.push({
                    x: g,
                    y: x - ba
                  })));
                  m = {
                  ...
                  0 <= B.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < B.markerSize) && (ba = B.getMarkerProperties(q, g, r, b), u.push(ba), f = Q(G),
                    v && u.push({
                      x: g,
                      y: r,
                      ctx: z,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          var w = a.dataSeriesIndexes[m],
            ...
            x = t.dataPoints;
          if (0 < x.length)
            for (var z = 5 < r && t.bevelEnabled ? !0 : !1, u = 0; u < x.length; u++)
              if (x[u].getTime ? g = x[u].x.getTime() : g = x[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[u].y) && x[u].y.length && "number" === typeof x[u].y[0] &&
                ...
                "candlestick" === t.type ? (c.moveTo(h - y, n), c.lineTo(h - y, Math.min(k, q)), c.stroke(), c.moveTo(h - y, Math.max(k, q)), c.lineTo(h - y, p), c.stroke(), ca(c, E, Math.min(k, q), C, Math.max(k, q), x[u].y[0] <= x[u].y[3] ? t.risingColor : f, B, e, z, z, !1, !1, t.fillOpacity), v && (e = Q(D), b.strokeStyle = e, b.moveTo(h - y, n), b.lineTo(h - y, Math.min(k,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = !1, m = !!a.axisY.reversed, w = 0; w < a.dataSeriesIndexes.length; w++) {
          var t = a.dataSeriesIndexes[w],
            ...
            z = x.dataPoints;
          if (0 < z.length)
            for (var E = 5 < r && x.bevelEnabled ? !0 : !1, l = 0; l < z.length; l++)
              if (z[l].getTime ? g = z[l].x.getTime() : g = z[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(z[l].y) && z[l].y.length && "number" === typeof z[l].y[0] && "number" === typeof z[l].y[1] && "number" === typeof z[l].y[2] && "number" === typeof z[l].y[3] && "number" === typeof z[l].y[4] && 5 === z[l].y.length) {
                ...
                var C = u - r / 2 << 0,
                  ...
                  H = z[l].stemDashType ? z[l].stemDashType :
                  x.stemDashType,
                ...
                c.restore();
                c.save();
                0 < P && (c.beginPath(), c.setLineDash && c.setLineDash(N(F, P)), c.strokeStyle = S, c.lineWidth = P, c.moveTo(u - aa / 2 << 0, p - fa), c.lineTo(u + aa / 2 << 0, p - fa),
                  c.stroke(), c.moveTo(u - aa / 2 << 0, h + fa), c.lineTo(u + aa / 2 << 0, h + fa), c.stroke());
                c.restore();
                ...
                (z[l].indexLabel || x.indexLabel || z[l].indexLabelFormatter ||
    ...
    m.prototype.renderRangeColumn = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null,
          e = this.plotArea,
          f = 0,
          l, u, h, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
          1;
        ...
        v && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), c.globalCompositeOperation =
    ...
    m.prototype.renderError =
      function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
          ...
          c.rect(l.x1, l.y1, l.width, l.height);
          c.clip();
          v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(l.x1,
          ...
          for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
            var z = a.dataSeriesIndexes[x],
              ...
              D = 0;
            if (B)
              for (e = E._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/ig) ||
            ...
            f && (u = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
              b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? w : 1))) << 0 : 0.03 * this.width);
            ...
            t > u && (t = u);
            if (0 < C.length)
              for (var F = E._colorSet, u = 0; u < C.length; u++) {
                ...
                var P = {
                  ...
                  dashType: C[u].stemDashType ?
                    C[u].stemDashType : E.stemDashType
                };
                ...
                if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(C[u].y) && C[u].y.length && "number" === typeof C[u].y[0] && "number" === typeof C[u].y[1]) {
                  ...
                  b ? p = ja : g = ja;
                  b ? (q = a.axisX.reversed ? k + (B ? w :
                    1) * t / 2 - (B ? D - 1 : 0) * t << 0 : k - (B ? w : 1) * t / 2 + (B ? D - 1 : 0) * t << 0, g = a.axisX.reversed ? q - t << 0 : q + t << 0) : (n = a.axisX.reversed ? h + (B ? w : 1) * t / 2 - (B ? D - 1 : 0) * t << 0 : h - (B ? w : 1) * t / 2 + (B ? D - 1 : 0) * t << 0, p = a.axisX.reversed ? n - t << 0 : n + t << 0);
                  !b && q > g && (ja = q, q = g, g = ja);
                  b && n > p && (ja = n, n = p, p = ja);
                  ja = E.dataPointIds[u];
                  ...
                  y(c, Math.min(n, p),
                    Math.min(q, g), Math.max(p, n), Math.max(g, q), e, S, P, b);
    ...
    m.prototype.renderRangeBar = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var b = null,
          e = this.plotArea,
          f = 0,
          l, u, h, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var S = !0; g < p.length; g++)
              if (t = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !S)))
                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                  ...
                  q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || B === n.lineDashType &&
                    n.lineDashType !== n.nullDataLineDashType) && (h[h.length - 1].newLineDashArray = D, B = n.nullDataLineDashType, b.setLineDash(y)), b.lineTo(r, m), v && e.lineTo(r, m), h.push({
                    x: r,
                    y1: m,
                    y2: s
    ...
    m.prototype.renderRangeSplineArea = function(a) {
      function d(a, c) {
        ...
        if (0 < d.length) {
          ...
          for (f = 0; f < d.length - 3; f += 3) b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y), v && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
          d = w(y, 2);
          b.lineTo(y[y.length -
            1].x, y[y.length - 1].y);
            ...
            for (g = !1; p < n.length; p++)
              if (q = n[p].x.getTime ? n[p].x.getTime() : n[p].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                ...
                if (null !== n[p].y && n[p].y.length && "number" === typeof n[p].y[0] && "number" === typeof n[p].y[1]) {
                  ...
                  p < n.length - 1 && (z !== (n[p].lineColor || x) || E !== (n[p].lineDashType || k.lineDashType)) && (z = n[p].lineColor || x, s[s.length -
                    1].newStrokeStyle = z, b.setLineDash && (n[p].lineDashType ? (E = n[p].lineDashType, s[s.length - 1].newLineDashArray = N(E, k.lineThickness)) : (E = k.lineDashType, s[s.length - 1].newLineDashArray = C)));
                  ...
                  (0 < s.length && (k.options.nullDataLineDashType || !n[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = B, E = k.nullDataLineDashType) : (d(C, x), s = [], y = [])), g = !0;
            d(C, x);
            W.drawMarkers(f)
          }
        }
    ...
    m.prototype.renderWaterfall = function(a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        c.rect(f.x1, f.y1, f.width, f.height);
        c.clip();
        v && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(f.x1,
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < w.length)
            for (var z = 5 < q && s.bevelEnabled ? !0 : !1, E = !1, C = null, B = null, l = 0; l < w.length; l++)
              if (w[l].getTime ?
                ...
                e = Q(e);
                v && ca(this._eventManager.ghostCtx, h, m, D, k, e, 0, null, !1,
                  !1, !1, !1);
                var P, S = h;
                ...
                C = D;
                B = 0 < w[l].y ? m : k;
                S = w[l].lineDashType ? w[l].lineDashType : s.options.lineDashType ? s.options.lineDashType :
                  "shortDash";
    ...
    var Y = function(a, d, c, b, e, f, l, h, m) {
      if (!(0 > c)) {
    ...
    m.prototype.renderPie = function(a) {
        ...
        if (k && n) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < n.length; e++) {
            ...
            h = f.indexLabelFormatter ? f.indexLabelFormatter(u) :
              f.indexLabel ? m.replaceKeywordsWithValue(f.indexLabel, f, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(u) : k.indexLabel ? m.replaceKeywordsWithValue(k.indexLabel, f, k, e) : f.label ? f.label : "";
      ...
      function c(a) {
        ...
        for (b = 0; b <
          ...
          if (d > c) {
            ...
            Y(m.plotArea.ctx, g[b].center, g[b].radius, n[b].color ? n[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius)
          }
        }
        a = m.plotArea.ctx;
        a.save();
        ...
        a.lineJoin = "round";
        for (b = b = 0; b < n.length; b++) c = g[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== k.indexLabelPlacement ? -(c.indexLabelTextBlock.width + p) : -c.indexLabelTextBlock.width / 2 : "inside" !==
          k.indexLabelPlacement ? p : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + B * Math.cos(c.midAngle), e = c.center.y + B * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(N(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(),
            a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -p : p), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
        a.save()
      }
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < n.length) {
          var h = g[a];
          if (0 > c && h.indexLabelTextBlock.y < l ||
          ...
          l = 0;
          l = "right" === h.hemisphere ? z.x + Math.sqrt(Math.pow(v,
            2) - Math.pow(c - z.y, 2)) : z.x - Math.sqrt(Math.pow(v, 2) - Math.pow(c - z.y, 2));
          ...
          0 > c ? (p = "right" === h.hemisphere ? u : q, k = c, null !== p && (u = -c, c = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - (g[p].indexLabelTextBlock.y + g[p].indexLabelTextBlock.height / 2), c - u < r && (l = -u, p = f(p, l, d + 1), +p.toFixed(x) > +l.toFixed(x) && (k = c > r ? -(c - r) : -(u - (p - l)))))) : 0 < c && (p = "right" === h.hemisphere ? q : u, k = c, null !== p && (u = c, c = g[p].indexLabelTextBlock.y - g[p].indexLabelTextBlock.height / 2 - (h.indexLabelTextBlock.y +
            h.indexLabelTextBlock.height / 2), c - u < r && (l = u, p = f(p, l, d + 1), +p.toFixed(x) < +l.toFixed(x) && (k = c > r ? c - r : u - (l - p)))));
          k && (d = h.indexLabelTextBlock.y + k, c = 0, c = "right" === h.hemisphere ? z.x + Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(v, 2) - Math.pow(d - z.y, 2)), h.midAngle > Math.PI / 2 - t && h.midAngle < Math.PI / 2 + t ? (l = (a - 1 + g.length) % g.length, l = g[l], a = g[(a + 1 + g.length) % g.length], "left" === h.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x ? c = l.indexLabelTextBlock.x - 15 : "right" === h.hemisphere && ("left" ===
            ...
            z.y, h.indexLabelTextBlock.x - z.x))
        }
        return k
      }
            ...
            for (var u, s, a = 0; a < n.length; a++) {
              ...
              if (null !== t) {
                ...
                if (0 > E) {
                  ...
                  var C = -1 * (E - s),
                    H = F = 0;
                  "right" === h.hemisphere ? (F = f(a, s), C = -1 * (E - F), H = f(t, C), +H.toFixed(x) < +C.toFixed(x) && +F.toFixed(x) <= +s.toFixed(x) && f(a, -(C - H))) : (F = f(t, s), C = -1 * (E - F), H = f(a, C), +H.toFixed(x) < +C.toFixed(x) &&
                    +F.toFixed(x) <= +s.toFixed(x) && f(t, -(C - H)))
                }
              }
            }
          } else
            for (a = 0; a < n.length; a++) h = g[a], v = "pie" === k.type ? 0.7 * B : 0.8 * B, t = z.x + v * Math.cos(h.midAngle), s = z.y + v * Math.sin(h.midAngle), h.indexLabelTextBlock.x = t, h.indexLabelTextBlock.y = s;
          for (a = 0; a < n.length; a++)
            if (h = g[a], t = h.indexLabelTextBlock.measureText(), 0 !== t.height && 0 !== t.width) t = t = 0, "right" === h.hemisphere ? (t = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p), t *= -1) : t = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p), 0 < t && (!l && h.indexLabelText &&
                ...
                if (null !== l) {
                  ...
                  if (q = 0 > E) {
                    ...
                    var m = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
                      ...
                      s = h.indexLabelTextBlock.y - h.indexLabelTextBlock.height /
                      2,
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var k = this.data[a.dataSeriesIndexes[0]],
          ...
          E = 0;
        a = !1;
        for (var C = 0; C < n.length; C++) E += Math.abs(n[C].y), !a && ("undefined" !== typeof n[C].indexLabel && null !== n[C].indexLabel && 0 < n[C].indexLabel.toString().length) && (a = !0), !a && ("undefined" !== typeof n[C].label && null !== n[C].label && 0 < n[C].label.toString().length) && (a = !0);
        if (0 !== E) {
          a = a || "undefined" !== typeof k.indexLabel && null !== k.indexLabel && 0 < k.indexLabel.toString().length;
          var B = "inside" !== k.indexLabelPlacement && a ? 0.75 * Math.min(q.width, q.height) / 2 : 0.92 * Math.min(q.width,
            q.height) / 2;
          ...
          this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
            ...
            for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < n.length; c++) {
              ...
              e > d && Y(m.plotArea.ctx, g[c].center,
                g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
              if (f) break
            }
            h();
            m.dispatchEvent("dataAnimationIterationEnd", {
    ...
    var pa = function(a, d, c, b) {
      ...
      0 >= Math.round(d.y4 - d.y1) || (a.save(), a.globalAlpha = c, a.beginPath(),
    ...
    m.prototype.renderFunnel = function(a) {
      ...
      function c() {
        ...
        if (0 === g) return -1;
        for (var l = d[0] = 0, n = 0, h, p, b = b - a, l = !1, k = 0; k < x.length; k++) a = Math.abs(x[k].y) * f / g, l ? h = 0 == Number(c.toFixed(3)) ?
          0 : a / c : (p = $ * $ * b * b - 4 * Math.abs($) * a, 0 > p ? (p = c, l = (b + p) * (e - n) / 2, a -= l, h = e - n, n += e - n, h += 0 == p ? 0 : a / p, n += a / p, l = !0) : (h = (Math.abs($) * b - Math.sqrt(p)) / 2, p = b - 2 * h / Math.abs($), n += h, n > e && (n -= h, p = c, l = (b + p) * (e - n) / 2, a -= l, h = e - n, n += e - n, h += a / p, n += a / p, l = !0), b = p)), d.push(h);
        return d
      }
      ...
      function b() {
        if (t && x) {
          for (var a, b, c, d, e, f, k, l, n, h, p, q, u, m, r = [], A = [], w = {
              percent: null,
              total: null
            }, E = null, z = 0; z < x.length; z++) m = O[z], m = "undefined" !== typeof m.x5 ? (m.y2 + m.y4) / 2 : (m.y2 + m.y3) / 2, m = g(m).x2 + 1, r[z] = J - m - V;
          m = 0.5 * V;
          for (var z = 0, B = x.length - 1; z < x.length ||
            0 <= B; z++, B--) {
            ...
            l = b.indexLabelFontFamily || t.indexLabelFontFamily ||
              "arial";
      ...
      function e() {
        ...
        for (var g, k = J - Z - V / 2, k = t.options.indexLabelMaxWidth ? t.indexLabelMaxWidth > k ? k : t.indexLabelMaxWidth : k, l = I.length - 1; 0 <= l; l--) {
          ...
          d = c.textBlock;
          b = (a =
            q(l) < O.length ? I[q(l)] : null) ? a.textBlock : null;
          c = c.height;
          a && d.y + c + da > b.y && (e = !0);
        ...
        if (e)
          for (l = I.length - 1; 0 <= l; l--) a = O[l], I[l].textBlock.maxWidth = f[f.length - (l + 1)], I[l].textBlock.measureText(), I[l].textBlock.x = J - k, c = I[l].textBlock.height < I[l].textBlock.maxHeight ? I[l].textBlock.height : I[l].textBlock.maxHeight, e = I[l].textBlock.width < I[l].textBlock.maxWidth ? I[l].textBlock.width : I[l].textBlock.maxWidth, I[l].height = c, I[l].width = e, c = "undefined" !== typeof a.x5 ?
            (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, I[l].textBlock.y = c - I[l].height / 2, t.reversed ? (I[l].textBlock.y + I[l].height > ma + E && (I[l].textBlock.y = ma + E - I[l].height), I[l].textBlock.y < ra - E && (I[l].textBlock.y = ra - E)) : (I[l].textBlock.y < ma - E && (I[l].textBlock.y = ma - E), I[l].textBlock.y + I[l].height > ra + E && (I[l].textBlock.y = ra + E - I[l].height))
      }

      function f() {
        var a, b, c, d;
        if ("inside" !== t.indexLabelPlacement)
          for (var e = 0; e < O.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 +
          ...
          for (e = 0; e < O.length; e++) 0 ==
            I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], b = a.height, c = I[e].height, d = I[e].width, b >= c ? (b = e != ca ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ca ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, I[e].textBlock.x = b, I[e].textBlock.y = c) : I[e].isDirty = !0)
      }
      ...
      function l() {
        ...
        function b() {
          ...
          for (var l, h = 1; h < k; h++) {
            e = h * f;
            for (var u = I.length - 1; 0 <= u; u--) !I[u].isDirty && (I[u].textBlock.y < e && I[u].textBlock.y + I[u].height > e) && (l = q(u), !(l >= I.length - 1) && I[u].textBlock.y + I[u].height + da > I[l].textBlock.y && (I[u].textBlock.y = I[u].textBlock.y + I[u].height - e > e - I[u].textBlock.y ? e + 1 : e - I[u].height - 1))
          }
        ...
        function c(a, b, d) {
          ...
          for (d = 0; d < e.length; d++)
            if (b = e[d], f < a) g++, f += I[b.id].height + da, I[b.id].textBlock.text =
              "", I[b.id].indexLabelText = "", I[b.id].isDirty = !0, I[b.id].textBlock.measureText();
            else break;
          return g
        }
      ...
      function h(a, b) {
        return (b < O.length ? I[b].textBlock.y : t.reversed ? ma + E : ra + E) - (0 > a ? t.reversed ? ra -
          E : ma - E : I[a].textBlock.y + I[a].height + da)
      }

      function m(a, b, c) {
        var d, e, g, l = [],
          h = E,
          p = []; - 1 !== b && (0 <= Y.indexOf(b) ? (e = Y.indexOf(b), Y.splice(e, 1)) : (Y.push(b), Y = Y.sort(function(a, b) {
          return a - b
        })));
        if (0 === Y.length) l = ga;
        else {
          e = E * (1 != Y.length || 0 != Y[0] && Y[0] != O.length - 1 ? 2 : 1) / k();
        ...
        g = function() {
          for (var a = [], b = 0; b < O.length; b++) a.push(l[b] -
            O[b].y1);
          return a
        }();
        var u = {
          ...
          changeSection: function(a) {
            for (var b, c, d = 0; d < O.length; d++) b = g[d], c = O[d], b *= a, "undefined" === typeof p[d] && (p[d] = 0), 0 > p && (p *= -1), c.y1 += b - p[d], c.y2 += b - p[d], c.y3 += b - p[d], c.y4 += b - p[d], c.y5 && (c.y5 += b - p[d], c.y6 += b - p[d]), p[d] = b
          }
        };
      ...
      function n(a) {
        for (var b, c, d, e, f = 0; f < O.length; f++) e =
      ...
      function w(a) {
        ...
        a.roundRect || Aa(a);
        y.title && (y.title.dockInsidePlotArea || "center" === y.title.horizontalAlign && "center" === y.title.verticalAlign) && (y.title.ctx =
          a, y.title.render());
        if (y.subtitles)
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (var t = this.data[a.dataSeriesIndexes[0]], x = t.dataPoints, z = this.plotArea,
            E = 0.025 * z.width, C = 0.01 * z.width, B = 0, D = z.height - 2 * E, F = Math.min(z.width - 2 * C, 2.8 * z.height), H = !1, P = 0; P < x.length; P++)
        ...
        if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
          ...
          a = 75 * F / 100;
          var V = 30 * (J - a) / 100;
          "funnel" === t.type ? (ba = s(t.options.neckHeight) ? 0.35 * D : t.neckHeight, G = s(t.options.neckWidth) ? 0.25 * a : t.neckWidth, "string" === typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * D / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G =
            parseInt(G), ba > D ? ba = D : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === t.type && (G = ba = 0, t.reversed = t.reversed ? !1 : !0);
          var C = P + a / 2,
            X = P,
            Z = P + a,
            ma = t.reversed ? Q : M,
          ...
          if (-1 !== P) {
            if (t.reversed)
              for (F.push(U), G = P.length - 1; 0 < G; G--) U += P[G], F.push(U);
            else
              for (G = 0; G < P.length; G++) U += P[G], F.push(U);
            if (t.reversed)
              for (G = 0; G < P.length; G++) F[G] <
                wa ? (a.push(K), C.push(W), ca = G) : (a.push((F[G] - ma + $ * X) / $), C.push((F[G] - ma + ea * Z) / ea));
            else
              for (G = 0; G < P.length; G++) F[G] < wa ? (a.push((F[G] - ma + $ * X) / $), C.push((F[G] - ma + ea * Z) / ea), ca = G) : (a.push(K), C.push(W));
            for (G = 0; G < P.length - 1; G++) U = t.reversed ? x[x.length - 1 - G].color ? x[x.length - 1 - G].color : t._colorSet[(x.length - 1 - G) % t._colorSet.length] : x[G].color ? x[G].color : t._colorSet[G % t._colorSet.length], G === ca ? O.push({
              x1: a[G],
              y1: F[G],
              x2: C[G],
              y2: F[G],
            ...
            a = a = 0;
            Ba(Y);
            for (G = 0; G < x.length; G++) x[G].exploded && (P = !0, t.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
            ...
            if (H && t.visible && (b(), f(), e(), "inside" !== t.indexLabelPlacement)) {
              l();
              for (G = 0; G < x.length; G++) I[G].isDirty || (a = I[G].textBlock.x +
                I[G].width, a = (J - a) / 2, 0 == G && (B = a), B > a && (B = a));
              for (G = 0; G < O.length; G++) O[G].x1 += B, O[G].x2 += B, O[G].x3 += B, O[G].x4 += B, O[G].x5 && (O[G].x5 += B, O[G].x6 += B), I[G].textBlock.x += B
            }
            ...
            if (!H)
              for (G = 0; G < x.length; G++) B = t.dataPointIds[G], a = {
                  id: B,
                  objectType: "dataPoint",
                  dataPointIndex: G,
                  dataSeriesIndex: 0,
                  funnelSection: O[t.reversed ? x.length - 1 - G : G]
                }, y._eventManager.objectMap[B] =
                a;
    ...
    m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
      ...
      if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
        ...
        do {
          ...
          a =
            a.replace("#percent", ea(l, m, f._cultureInfo));
      ...
      return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
        ...
        if ("x" === a)
          if ("dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) {
            if (!c.axisX.logarithmic) return za(g, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ?
              c.xValueFormatString : c.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo)
        ...
        else return "y" === a ? ea(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? ea(g, d.zValueFormatString ? d.zValueFormatString :
          c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : g
      })
    };
    na(F, V);
    F.prototype.setLayout = function() {
      ...
      for (var n = 0; n < this.dataSeries.length; n++) {
        ...
        if (p.dataPoints && p.dataPoints.length)
          if ("pie" !==
            p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
            var q = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? "error" === p.type && p._linkedSeries ? p._linkedSeries.legendMarkerType ? p._linkedSeries.legendMarkerType : H.getDefaultLegendMarker(p._linkedSeries.type) : H.getDefaultLegendMarker(p.type) : p.markerType,
              ...
              t = p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : p.markerBorderThickness ? Math.max(1, Math.round(0.2 *
                v)) : 0;
            ...
            for (var x = 0; x < p.dataPoints.length; x++) {
              var z = p.dataPoints[x],
                ...
                g = z.legendText ?
                z.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                  chart: this.chart,
                  legend: this.options,
                  dataSeries: p,
                  dataPoint: z
                ...
                w = z.legendMarkerBorderColor ? z.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : z.markerBorderColor ? z.markerBorderColor :
                p.markerBorderColor,
    ...
    D.prototype.createLabels = function() {
      ...
      if ("bottom" === this._position || "top" === this._position) h = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) *
        R[this.intervalType + "Duration"] * this.interval, f = "undefined" === typeof this.options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this.options.labelMaxWidth, this.chart.panEnabled || (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
      ...
      for (c = 0; c < this.stripLines.length; c++) {
        ...
        if ("outside" === f.labelPlacement) {
          ...
          "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize, s(f.labelBackgroundColor) && (s(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = v ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE");
        a = new ia(this.ctx, {
          x: 0,
          y: 0,
    ...
    D.setLayout = function(a, d, c, b, e, f) {
      ...
      for (var w = v = 0, t = 0, x = 0, z = 0, y = 0, C = 0, B, D, F = h = 0, H, J, L, r = H = J = L = !1, g = 0; g < q.length; g++) q[g] && q[g].title && (q[g]._titleTextBlock = new ia(q[g].ctx, {
        text: q[g].title,
        horizontalAlign: "center",
      ...
      if ("normal" === e) {
        for (var x = [], z = [], y = [], C = [], M = [], N = [], Q = [], R = []; 4 >
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++) d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K), d[g].lineCoordinates.x2 =
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++) K = n.isNavigator ? 0 : 10, c[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[c[g]._labels.length - 1].textBlock.height / 2 : p, h = Math.round(f.y1 + W + X < Math.max(K, p) ? Math.max(K, p) : f.y1 + W + X), m = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height /
              2 : p, k = Math.round(f.y2 - U - e - K), c[g].lineCoordinates = {
                x1: l - V,
                y1: h,
                x2: m - V,
                y2: k,
                ...
                c[g].lineCoordinates.height ? c[g].titleMaxWidth : c[g].lineCoordinates.height), V += y[g] + c[g].margin);
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++) b[g] && (l = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2), m = Math.round(l), K = b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[b[g]._labels.length - 1].textBlock.height / 2 : 0, h = Math.round(f.y1 + W + X < Math.max(K, p) ? Math.max(K, p) : f.y1 + W + X), K = 0 < a.length ? 0 : b[g]._labels && 0 < b[g]._labels.length ? b[g]._labels[0].textBlock.height / 2 : 0, k = Math.round(f.y2 - (U + e + K)), b[g].lineCoordinates = {
              x1: l + Y,
              y1: h,
              x2: l + Y,
              y2: k,
              ...
              b[g].lineCoordinates.height), Y += C[g] + b[g].margin);
          if (a && 0 < a.length)
            for (g = 0; g < a.length; g++) a[g] && (a[g].calculateValueToPixelConversionParameters(), a[g].calculateBreaksSizeInValues(), a[g]._labels && 1 < a[g]._labels.length && (B = (a[g].logarithmic ? Math.log(a[g]._labels[1].position / a[g].viewportMinimum) / a[g].conversionParameters.lnLogarithmBase : a[g]._labels[1].position - a[g].viewportMinimum) * Math.abs(a[g].conversionParameters.pixelPerUnit) + a[g].lineCoordinates.x1, l = a[g]._labels[a[g]._labels.length - ("dateTime" ===
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++) d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (B = (d[g].logarithmic ?
          ...
          if (0 < v) {
            ...
            if (d && 0 < d.length)
              for (g = 0; g < d.length; g++) H = N[v - 1][g] === N[v][g] ? !0 : !1;
            else H = !0;
            if (c && 0 < c.length)
              for (g = 0; g < c.length; g++) J = Q[v - 1][g] === Q[v][g] ? !0 : !1;
            else J = !0;
            if (b && 0 < b.length)
              for (g = 0; g < b.length; g++) L = R[v -
                1][g] === R[v][g] ? !0 : !1;
            else L = !0
          }
          if (r && H && J && L) break;
        ...
        for (N = []; 4 > v;) {
          ...
          if (a && 0 < a.length)
            for (F = [], g = Y = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), Y += F[g], e += a[g] && !n.isNavigator ? a[g].margin : 0;
          else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
          M.push(F);
          if (d && 0 < d.length)
            for (w = [], g = U = 0; g < d.length; g++) w.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), U += w[g], X += d[g] ? d[g].margin : 0;
          else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() :
            0));
          N.push(w);
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, l = Math.round(f.x1 + Y + e), m = Math.round(f.x2 - U - X > n.width - 10 ? n.width - 10 : f.x2 - U - X), c[g].labelAutoFit && !s(x) && (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, x) : 0 === c[g].labelAngle ? Math.max(l, x / 2) : l), 0 < !d.length && (m = 0 < c[g].labelAngle ? m - z / 2 : 0 === c[g].labelAngle ? m - z / 2 : m)), c[g].lineCoordinates.x1 = l, c[g].lineCoordinates.x2 = m, c[g].lineCoordinates.width = Math.abs(m - l), c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth <
              c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width);
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + Y + e), m = Math.round(f.x2 - U - X > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - U - X), b[g] && b[g].labelAutoFit && !s(y) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, y) : 0 === b[g].labelAngle ? Math.max(l, y / 2) : l), 0 < !d.length && (m -= C / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth =
              0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width);
          if (c && 0 < c.length)
            for (p = [], g = V = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), V += p[g] + c[g].margin, K += c[g].margin;
          else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
          D.push(p);
          if (b && 0 < b.length)
            for (B = [], g = T = 0; g < b.length; g++) B.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), T += B[g], Z += b[g].margin;
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (k = b[g]._labels[0], h = b[g]._labels[b[g]._labels.length - 1], y = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), C = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)));
          if (n.panEnabled)
          ...
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--) h = Math.round(f.y2), k = Math.round(f.y2 > c[g].chart.height ? c[g].chart.height : f.y2), c[g].lineCoordinates.y1 = h - (p[g] + c[g].margin + W), c[g].lineCoordinates.y2 = h - (p[g] + c[g].margin + W), "inside" === c[g].labelPlacement && 0 < g && (c[g].lineCoordinates.y1 = c[g].lineCoordinates.y1 + p[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0) - ("inside" ===
          ...
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--) b[g] && (h = Math.round(f.y1), k = Math.round(f.y1 + (B[g] + b[g].margin + G)), b[g].lineCoordinates.y1 =
              k, b[g].lineCoordinates.y2 = k, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = k - B[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
                x1: l,
                y1: h + (b[g].margin + G),
                x2: m,
                y2: k,
          ...
          if (a && 0 < a.length)
            for (g = 0; g < a.length; g++) {
              ...
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (m = 0 > c[K].labelAngle ? Math.max(m, x) : 0 === c[K].labelAngle ? Math.max(m, x / 2) : m, l =
                  0 > c[K].labelAngle || 0 === c[K].labelAngle ? m - Y : l);
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (m = b[K].lineCoordinates.x1, l = m - Y);
              a[g].lineCoordinates = {
                x1: m - Q,
                y1: h,
                x2: m - Q,
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++) {
              ...
              k = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - V > n.height - Math.max(K, 10) ? n.height - Math.max(K, 10) : f.y2 - V) : f.y2 > n.height - Math.max(K, 10) ? n.height - Math.max(K, 10) : f.y2;
              if (c && 0 < c.length)
                for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (m = 0 > c[K].labelAngle ? Math.max(m, x) : 0 === c[K].labelAngle ? Math.max(m, x / 2) : m, l = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? m - U : l);
              if (b && 0 < b.length)
                for (K = 0; K < b.length; K++) b[K] &&
                  b[K].labelAutoFit && (m = b[K].lineCoordinates.x2, l = m - U);
              d[g].lineCoordinates = {
                x1: m + R,
                y1: h,
                x2: m + R,
          ...
          if (0 < v) {
            ...
            if (d && 0 < d.length)
              for (g = 0; g < d.length; g++) H = N[v - 1][g] === N[v][g] ? !0 :
                !1;
            else H = !0;
            if (c && 0 < c.length)
              for (g = 0; g < c.length; g++) J = D[v - 1][g] === D[v][g] ? !0 : !1;
            else J = !0;
            if (b && 0 < b.length)
    ...
    D.prototype.calculateAxisParameters = function() {
      if (this.logarithmic) this.calculateLogarithmicAxisParameters();
        ...
        s(this.sessionVariables.newViewportMinimum) && (this.viewportMinimum =
    ...
    D.prototype.calculateLogarithmicAxisParameters = function() {
      ...
      var h = (isNaN(this.viewportMaximum) || null === this.viewportMaximum ?
    ...
    $.prototype.showAt = function(a) {
      ...
      if ("xySwapped" === d.plotInfo.axisPlacement)
        ...
        for (b = 0; b < d.axisY2.length; b++) this.parent === d.axisY2[b] && (d.axisY2[b]._crosshairValue = a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum ? a : null);
      for (b = 0; b < d.axisX.length; b++) a = d.axisX[b]._crosshairValue, d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !s(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum) &&
      ...
      for (b = 0; b < d.axisY.length; b++) a = d.axisY[b]._crosshairValue, d.axisY[b].crosshair && (d.axisY[b].crosshair.enabled &&
        !s(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum) && (d.axisY[b].showCrosshair(a), d.axisY[b].crosshair._updatedValue = a, this === d.axisY[b].crosshair && (c = !0));
    ...
    $.prototype.render = function(a, d, c) {
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible &&
            n.push(v));
          v = null;
          ...
          if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type)
            for (var v = Math.abs(a - this.parent.convertValueToPixel(n[w].dataPoint.y[0])), t = 0, r = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                for (var x = 0; x < n[r].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r);
              else t =
                Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y)), t < v && (v = t, w = r);
          else if ("stackedBar" === n[0].dataSeries.type)
            for (var v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), z = t = 0, r = w = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                for (x = 0; x < n[r].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r);
            ...
            for (var v =
                Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y)), y = z = t = 0, r = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                for (x = 0; x < n[r].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r);
          ...
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
              ...
              for (r = t = 0; r < x.dataPoint.y.length; r++) t = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[r])), t < v && (v = t, b = r);
              ...
              k.text = this.labelFormatter ? this.labelFormatter({
                ...
                }) : s(this.options.label) ? ea(c ? c : x.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) :
                this.label
            } else if ("stackedBar" === this.parent.dataSeries[w].type) {
              v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
              z = t = 0;
              for (r = w; 0 <= r; r--) z += n[r].dataPoint.y, t = Math.abs(a - this.parent.convertValueToPixel(z)), t < v && (v = t, b = r);
              ...
              v = Math.abs(a - this.parent.convertValueToPixel(n[0].dataPoint.y));
              y = z = t = 0;
              for (r = w; 0 <= r; r--) z += n[r].dataPoint.y, y = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, y = 100 * (z / n[r].dataSeries.plotUnit.dataPointYSums[y]), t = Math.abs(a - this.parent.convertValueToPixel(y)), t < v && (v = t, b = r);
              h = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(y) << 0) + 0.5 : this.parent.convertValueToPixel(y) <<
                0;
              this.value = y;
              k.text = this.labelFormatter ? this.labelFormatter({
                chart: this.chart,
            ...
            k.y + k.height >
              this.chart.bounds.y2 ? k.y = this.chart.bounds.y2 - k.height : k.y < this.chart.bounds.y1 && (k.y = this.chart.bounds.y1)
            ...
            k.y = l + k.fontSize / 2 - k.measureText().height /
              2 + 2;
          ...
          for (w = 0; w < this.parent.dataSeries.length; w++)(v =
            this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
          if (0 === n.length) return;
          n.sort(function(a, b) {
            return a.distance - b.distance
          });
          ...
          for (w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && v.dataSeries.visible && n.push(v));
          if (0 === n.length) return;
          n.sort(function(a, b) {
            return a.distance - b.distance
          });
          ...
          if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" === n[0].dataSeries.type || "candlestick" === n[0].dataSeries.type || "ohlc" === n[0].dataSeries.type ||
            ...
            for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y[0])), r = t = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                for (x = 0; x < n[r].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r);
            ...
            for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = y = z = t = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                for (x =
                  0; x < n[r].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r);
            ...
            for (v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y)), r = t = 0; r < n.length; r++)
              if (n[r].dataPoint.y && n[r].dataPoint.y.length)
                for (x = 0; x < n[r].dataPoint.y.length; x++) t =
                  Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y[x])), t < v && (v = t, w = r);
              else t = Math.abs(d - this.parent.convertValueToPixel(n[r].dataPoint.y)), t < v && (v = t, w = r);
          x = n[w];
          b = 0;
          if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
            v =
              Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[0]));
            for (r = t = 0; r < x.dataPoint.y.length; r++) t = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[r])), t < v && (v = t, b = r);
            ...
            k.text = this.labelFormatter ? this.labelFormatter({
              ...
              crosshair: this.options,
              value: c ? c : x.dataPoint.y[b]
            }) : s(this.options.label) ? ea(c ? c : x.dataPoint.y[b], this.valueFormatString,
            ...
            z = t = 0;
            for (r = w; 0 <= r; r--) z += n[r].dataPoint.y, t = Math.abs(d - this.parent.convertValueToPixel(z)), t < v && (v = t, b = r);
            ...
            v = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y));
            z = t = 0;
            for (r = w; 0 <= r; r--) z += n[r].dataPoint.y, y = n[r].dataPoint.x.getTime ? n[r].dataPoint.x.getTime() : n[r].dataPoint.x, y = 100 * (z / n[r].dataSeries.plotUnit.dataPointYSums[y]),
              t = Math.abs(d - this.parent.convertValueToPixel(y)), t < v && (v = t, b = r);
            ...
            0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum
          }) : s(this.options.label) ? ea(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (m = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) <<
            0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({
            chart: this.chart,
            axis: this.parent.options,
            crosshair: this.options,
            value: x.dataPoint.y
        ...
        if ("bottom" === this.parent._position || "top" === this.parent._position) "top" === this.parent._position && k.y - k.fontSize / 2 < this.chart.bounds.y1 && (k.y = this.chart.bounds.y1 + k.fontSize /
          ...
          typeof k.text.valueOf() || 0 < k.text.length) && k.render(!0));
        if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.measureText().width), l >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ?
          this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < p && (q.moveTo(b, f), q.lineTo(e, l), q.stroke(), this._hidden = !1), q.restore(), !s(k.text) && ("number" === typeof k.text.valueOf() || 0 < k.text.length) && k.render(!0))
      } else {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
          if ("left" === this.parent._position || "right" === this.parent._position) {
            ...
            if (this.parent.labels)
              ...
              if ("axisX" === this.parent.type)
                for (r = this.parent.convertPixelToValue({
                  ...
                  this.parent.dataSeries[w].getDataPointAtX(r, !0)) && 0 <= v.index && (k.text = this.labelFormatter ? this.labelFormatter({
                  chart: this.chart,
                  axis: this.parent.options,
                  crosshair: this.options,
            ...
            }) : s(this.options.label) ? za(c ?
              c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
              chart: this.chart,
              axis: this.parent.options,
              crosshair: this.options,
              value: c ? c : this.parent.convertPixelToValue(d)
            ...
            k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y =
              this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2);
          ...
          k.x + k.width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.width);
          k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1);
          "bottom" === this.parent._position ? k.y = this.parent.lineCoordinates.y2 + k.fontSize / 2 + 2 : "top" === this.parent._position &&
            ...
            crosshair: this.options,
            value: c ? c : this.parent.convertPixelToValue(d)
          }) : s(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label, k.y = d + k.fontSize / 2 - k.measureText().height / 2 + 2, k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y =
          this.chart.bounds.y1 + k.fontSize / 2 + 2 : k.y + k.measureText().height - k.fontSize / 2 > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.measureText().height + k.fontSize / 2), "left" === this.parent._position ? k.x = this.parent.lineCoordinates.x2 - k.measureText().width : "right" === this.parent._position && (k.x = this.parent.lineCoordinates.x2);
        "left" === this.parent._position && k.x < this.chart.bounds.x1 ? k.x = this.chart.bounds.x1 : "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 ? k.x = this.chart.bounds.x2 -
          k.measureText().width : "top" === this.parent._position && k.y - k.fontSize / 2 < this.chart.bounds.y1 ? k.y = this.chart.bounds.y1 + k.fontSize / 2 : "bottom" === this.parent._position && this.parent.lineCoordinates.y2 - k.fontSize / 2 + k.measureText().height > this.chart.bounds.y2 && (k.y = this.chart.bounds.y2 - k.height + k.fontSize / 2 + 2);
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var m = 0; m < this.chart.axisX.length; m++) {
                for (var l = this.chart.axisX[m].convertPixelToValue({
                    ...
                    k = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(k = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[m].dataSeries[b], null !== k.dataPoint.y && h.push(k));
                k = null
              }
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++) {
                ...
                k = null;
                for (b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)(k = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(l, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[m].dataSeries[b], null !== k.dataPoint.y && h.push(k));
                k = null
              }
          } else {
            h = [];
            if (this.chart.axisX)
              for (m = 0; m < this.chart.axisX.length; m++)
                for (l = this.chart.axisX[m].convertPixelToValue({
                  ...
                  k = null, b = 0; b < this.chart.axisX[m].dataSeries.length; b++)(k = this.chart.axisX[m].dataSeries[b].getDataPointAtX(l,
                  c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[m].dataSeries[b], null !== k.dataPoint.y && h.push(k));
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++)
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (!s(k) && !s(k.dataPoint) && !s(k.dataPoint.y))
              if (k.dataSeries.axisY)
                if (0 <
                ...
                } else "column" === e.type || "bar" === e.type ? 0 > k.dataPoint.y ? 0 > k.dataSeries.axisY.viewportMinimum && k.dataSeries.axisY.viewportMaximum >= k.dataPoint.y && f.push(k) : k.dataSeries.axisY.viewportMinimum <= k.dataPoint.y && 0 <= k.dataSeries.axisY.viewportMaximum && f.push(k) : "bubble" === e.type ?
                  (c = this.chart._eventManager.objectMap[e.dataPointIds[k.index]].size / 2, k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum - c && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum + c && f.push(k)) : "waterfall" === e.type ? (c = 0, k.cumulativeSumYStartValue < k.dataSeries.axisY.viewportMinimum ? c-- : k.cumulativeSumYStartValue > k.dataSeries.axisY.viewportMaximum && c++, k.cumulativeSum < k.dataSeries.axisY.viewportMinimum ? c-- : k.cumulativeSum > k.dataSeries.axisY.viewportMaximum && c++, 2 > c && -2 < c && f.push(k)) : (0 <= k.dataSeries.type.indexOf("100") ||
                    "stackedColumn" === e.type || "stackedBar" === e.type || k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum) && f.push(k);
            else f.push(k)
          }
        }
        if (0 < f.length) {
    ...
    var L = {
      ...
      W = {
        ...
        drawMarkers: function(a) {
          for (var d = 0; d < a.length; d++) {
            var c = a[d];
            W.drawMarker(c.x, c.y, c.ctx, c.type,
